...
curl -H "Agent-Version-Control: on" -L $MANAGERURL/software/agent/${runningPlatform}${majorVersion}/${archType}/$package?tenantID=133050 -o /tmp/$package $CURLOPTIONS
...
/opt/ds_agent/dsa_control -a $ACTIVATIONURL "tenantID:A92246CD-0892-61B6-8D00-F94345899B76" "token:A8850E80-B93A-AC99-1F49-1BE9B3018132" "policyid:166"
# /opt/ds_agent/dsa_control -a dsm://agents.deepsecurity.trendmicro.com:443/ "tenantID:A92246CD-0892-61B6-8D00-F94345899B76" "token:A8850E80-B93A-AC99-1F49-1BE9B3018132" "policyid:166"